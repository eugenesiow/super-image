...
train_model('../BAM/DIV2K_train_HR_x4_train.h5', '../BAM/DIV2K_val_HR_x4_val.h5', 4, './results_carn_4x')
train_model('../BAM/DIV2K_train_HR_x2_train.h5', '../BAM/DIV2K_val_HR_x2_val.h5', 2, './results_carn_2x')
train_model('../BAM/DIV2K_train_HR_x3_train.h5', '../BAM/DIV2K_val_HR_x3_val.h5', 3, './results_carn_3x')
